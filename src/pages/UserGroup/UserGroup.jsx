...
import { useGetUsersByGroupMutation, useGetAllUsersQuery, useGetAllGroupsQuery, useEditGroupMutation, useCreateGroupMutation, useDeleteGroupMutation, useAddUserToGroupMutation, useRemoveUserFromGroupMutation, useRemoveRightFromGroupMutation,
  useGetRightsByGroupMutation,
  useAddRightToGroupMutation, 
  useGetAllRightsQuery} from "../../features/apiSlice";
import {
  Notification,
  NotificationGroup,
...
const UserGroup = () => {
  ...
  return (
    ...
    <div className="tables">
    {
      idGroup ?
      <div>
      <div className="add_to_group">Добавить пользователей в группу под названием {getNameById(idGroup)}</div>
    <Grid
      data={users}
      className="grid"
      style={{
    ...
    }
    {
      idGroup ?
      <div>
      <div className="add_to_group">Добавить права в группу под названием {getNameById(idGroup)}</div>
    <Grid
      data={rights}
      className="grid"
      style={{
